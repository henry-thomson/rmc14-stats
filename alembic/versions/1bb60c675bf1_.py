...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["faction_id"], ["factions.id"], name=op.f("fk_jobs_faction_id_factions")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["winning_faction"],
            ["factions.id"],
            name=op.f("fk_rounds_winning_faction_factions"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"], ["jobs.id"], name=op.f("fk_players_rounds_job_id_jobs")
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["players.id"],
